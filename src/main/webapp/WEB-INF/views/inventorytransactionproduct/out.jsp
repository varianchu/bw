...
<div>
<h3>INVENTORY OUT TRANSACTION</h3>
...
<tr>
	...
	<td>&nbsp;&nbsp;<input onkeypress="return isNumberKey(event)" id="productId" onchange="getProductInfo()" class="span10" autofocus/></td>
</tr>
<tr>
	...
	<table class="table table-bordered table-condensed">
		...
		<tr>
  		...
  		<tr>
  			...
  			<td>Php&nbsp;&nbsp;<input type="text" class="span10" id="showProductSale" style="font-weight:bold;"/></td>
  		</tr>
  	</table>
</div>
...
<div class="offset5 row" id="srpChecker">

	<b style="font-size:30px; margin-left:60px;">TOTAL SRP: </b><input disabled="disabled" class="span6" style="margin-top:-10px; font-size:30px;" value="Php 0.00" id="srpText">

</div>

<form:form action = "/stocktransaction-out" method = "POST" modelAttribute = "transaction">
	<form:hidden path="id"/>
