...
<form:form action = "/admin/product" method = "POST" modelAttribute = "product" enctype="multipart/form-data" class="form-horizontal">
	...
	<legend id="total">
		Total Quantity: <form:input type="text" path="totalQty" readonly="true" class="span2" style="text-align:center"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="row"></div>
	<div class="span3 container" style="margin-left:-30">
	<div class="control-group">
		...
		<div class="controls" style="margin-top:20">
			<form:select id="inputUOM" items="${uoms}" path="unitOfMeasure" class="span2"/>
		...
		<label class="control-label" for="inputQuantity" style="margin-top:20">Quantity:</label>
		<div class="controls" style="margin-top:20">
			<form:input type="text" id="inputQuantity" path="qty" class="span2"/>
		...
		<div class="controls " style="margin-top:20">
			<form:input type="text" id="inputSRP" path="srp" class="span2"/>
			<form:errors path="srp" style="color:red;"/>
		</div>
		
		<label class="control-label" for="inputDescription" style="margin-top:20">Description:</label>
		<div class="controls" style="margin-top:20">
			<form:textarea type="text" class="input-xlarge span3" path="description" id="inputDescription" />
		...
		<div class="controls" style="margin-top:20;">
			<a href="/admin/barcode/${product.code}" class="btn" target="_blank">Generate Barcode</a>
		</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<form:input type="text" id="inputCode" path="code" placeholder="Code" class="span2"/>
		...
		<div class="controls" style="margin-top:20">
			<form:select id="brand" path="brandName" class="span2">
		...
		<div class="controls" style="margin-top:20">
			<form:input type="text" id="inputCost" path="cost" class="span2"/>
...
<!-- 		<label class="control-label" for="newCost" style="margin-top:20" id ="newCostLabel">New Cost of Good:</label> -->
<!-- 		<div class="controls" style="margin-top:20"> -->
<%-- 			<form:checkbox id="newCost" path="newPrice" value="true" style="margin-top:10"/> --%>
<!-- 		</div> -->
<%-- 		</c:if> --%>
...
// 	var urlString = "/admin/barcode/";
// 	var barcodeString = barcode;
// 	var url = urlString + barcodString;
// 	window.open(url);
// 	alert(barcode);
// }
