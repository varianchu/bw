...
<div>
<h3 id="transactionTitle">VIEW SERVICE TRANSACTIONS by SALES REPRESENTATIVE</h3>
<hr></hr>

<div class="row well span12">

	<div class="span4">
		<form:form action = "/admin/view-service-transactions-user" method = "POST" modelAttribute = "serviceTransactionForm">
  ...
  <div class="span8">
  	<table class="table table-striped table-bordered table-condensed">
  		...
  		<tr>
  			...
  			<td><b style="font-size:30px;">${user.firstName} ${user.lastName}</b></td>
  		</tr>
  	</table>
  </div>	
</div>
